        ...
        body: GetBuilder<RepairController>(
          ...
          builder: (controller) {
            return Padding(
              ...
              child: Column(
                children: [
                  Container(width: Get.width * 0.9, height: Get.height * 0.06,margin: EdgeInsets.only(bottom: 10), child: CommomTextFormFeild(
                    controller: controller.searchController,onChanged: (value) {
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  ...
                                                  style: TextStyle(color: repairAllData[index].iconColor, fontSize: 12),
                                                )),
                                              ),
                                            ),
