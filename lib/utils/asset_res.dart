class AssetRes {
  ...
  static const location = '${icon}location.png';
  static const machine = '${icon}machine.png';
  static const employee = '${icon}Employee.png';
...
//   static const vector = '${icons}locator.png';
...
//   static const appleLogo = "${images}apple-black-logo2.png";
//
//   static const splashLogo = "${images}logo2.png";
//
